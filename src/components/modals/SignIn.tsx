...
const SignIn = ({ setForModal, forModal, setIsEmail, setIsPhoneNumber }: HeroVideoProps) => {
                ...
                >
                    <div className='flex flex-col gap-[10px] h-fit pb-[37px] px-[32px] ' >
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex flex-col gap-5'>
                                <button onClick={() => { closeModal(); setIsEmail(true) }} className='font-Poppins rounded-[6px] font-medium text-[14px] leading-7 text-center text-white bg-[#FF0080] px-[24px] py-[10px]'>Agree and Sign up</button>
