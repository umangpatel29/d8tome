...
import { UserProfile } from '@/services/http/profile';
...
const CreateAccountSteps = () => {
    ...
    const handleCreateUser = () => {
        let create_user = JSON.parse(localStorage.getItem('create_user') as string)
        setTimeout(() => {
            console.log(create_user, "ayush user profile")
    ...
    useEffect(() => {
        localStorage.setItem('create_user', JSON.stringify(formik.values))
    }, [currentStep])
                ...
                <div className=' w-full md:w-[70%] mx-auto mt-7 '>
                    ...
                    >
                        <div className="w-full md:w-[80%] mx-auto mt-5">
                            ...
                            <div className=''>
                                ...
                                {
                                    currentStep === 1 && (
                                        <StepTwo formik={formik} handleStepClick={handleStepClick} />
                                    )
                                }
                                {
                                    currentStep === 2 && (
                                        <StepThree formik={formik} handlePhotosUploaded={handlePhotosUploaded} />
                                    )
                                }
                                {
                                    currentStep === 3 && (
                                        <StepFour formik={formik} handleStepClick={handleStepClick} />
                                    )
                                }
                            </div>
                        </div>
                    ...
                    <div className='flex justify-between mt-7'>
                        ...
                        <div className='flex items-center gap-10'>
                            ...
                            {
                                currentStep === 3 ?
                                    <button onClick={() => { handleCreateUser(); }} type='submit' className={`bg-primary px-8 py-4 text-white font-semibold text-[14px] leading-5 rounded-[4px]`}>
                                        Submit
                                    </button> :
